...
Route::get('/', function () {
    ...
    Route::get('/order/block/{event}/{orderId}', [OrderController::class, 'block_order'])->name('order.block.most');//datos al modal
    ...
    Route::get('/test/mail', [DocumentController::class, 'test_mail'])->name('document.mail');
