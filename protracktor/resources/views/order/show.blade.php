    ...
    <div class="col">
        <div>
            <div class="d-flex align-items-center justify-content-between bg-secondary rounded p-3 mb-7 border border-gray-900 draggable-handle">
                ...
                <a class="btn btn-sm me-1 p-1" href="{{ route('order.block.most', [$event_version->event, $orderId])}}">
                    <button class="btn btn-lg btn-success p-6" type="button" data-component="send" id="sub_block">
                        SEND
                    </button>
                </a>
                @endif
